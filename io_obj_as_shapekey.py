...
class LoadObjAsShapekey(bpy.types.Operator):
    ...
    # Highlight in Import menu only when a mesh is selected
    @classmethod
...
# When called in register(), this function assigns the new option to the Import menu at the top of the screen.
